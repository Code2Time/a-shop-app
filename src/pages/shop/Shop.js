...
function Shop() {
  ...
  return (
    <>
      <Navbarpro />
      <div className="shop-item-contaainer border rounded-lg max-w-[1000px] h-auto w-5/6 m-auto py-8 px-8  mt-14 grid grid-cols-12 gap-2 ">
        ...
        <h1 className="Lamia col-span-12 border-r-4 border-r-slate-800 py-2 px-2">معرفی محصول</h1>
        ...
        <h1 className="Lamia" ><span className="price-item Lamia">{Data.price}</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {Data.off}</h1>
        </div>
